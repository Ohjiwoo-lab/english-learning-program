...
class GameMenuPage(tk.Frame):
    ...
    def __init__(self,master):
        ...
        background=Image.open("C:/Python_project/image/background.png")
        #이미지 크기 재조정
    ...
    def gui_frame(self):
        top_word=Image.open("C:/Python_project/image/top_word_blue.png")
        #이미지 크기 재조정
        ...
        word_box=Image.open("C:/Python_project/image/word_box1.png")
        #이미지 크기 재조정
        ...
        self.click_anagram=ImageTk.PhotoImage(Image.open('C:/Python_project/image/anagram_but1.png'))
        self.but_img = ImageTk.PhotoImage(Image.open('C:/Python_project/image/anagram_but.png'))
        ...
        self.click_draw=ImageTk.PhotoImage(Image.open('C:/Python_project/image/draw_but1.png'))
        self.but_img1 = ImageTk.PhotoImage(Image.open('C:/Python_project/image/draw_but.png'))
