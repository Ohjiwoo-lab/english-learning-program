...
class LevelOne(tk.Frame):
    ...
    def gui_frame(self):
        ...
        img2 = tk.PhotoImage(file="image/box1.png")

        for i in range(3):
            for j in range(4):
                buttons.append(tk.Button(self, image=img2, width=150, height=105))
        ...
        tk.Label(self, text='0 / 6', font=fontStyle, bg='white', fg='black').place(x=750, y=140)
